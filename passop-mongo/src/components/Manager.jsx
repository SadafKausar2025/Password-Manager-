...
const Manager = () => {
  ...
  return (
    <>
      ...
      <div className="p-2 pt-3 md:mycontainer min-h-[95vh]">
        ...
        <div className="flex flex-col p-4 text-black gap-8 justify-center items-center">
          <input
            ...
            placeholder="Enter Websites URL"
            type="text"
            name="site"
            id="site"
          />
          ...
          <button
            ...
            className="flex justify-center items-center gap-2 bg-green-600 rounded-full px-8 py-2 w-fit hover:bg-green-400 border-1 border-green-900">
            <lord-icon
                    ...
                    <tr key={index}>
                      <td className="py-1 border border-white text-center">
                        <div className="flex justify-center items.center">
                          ...
                          <div
                            className="loardiconcopy cursor-pointer size-5"
                            onClick={() => {
                              copyText(item.site);
                            }}>
                            <lord-icon
